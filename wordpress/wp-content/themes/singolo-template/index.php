	...
	<div id="slider" class="theme-default">
        <div class="inner">
        	...
        	<div class="nivo-slider nivoSlider">
                <a href=""><img src="<?php bloginfo( 'template_url' ); ?>/images/slides/singolo-slide1.jpg" alt="#" /></a>
                <img src="<?php bloginfo( 'template_url' ); ?>/images/slides/singolo-slide2.jpg" alt="#" />
            </div>
	...
	<div id="about">
        <div class="inner">
            ...
            <ul>
            	<li>
                	<img src="<?php bloginfo('template_url')?>/images/profile/profile1.jpg" width="300" height="300" alt="#" />
                    <h4>Adam Jensen</h4>
                    <p>Quisque luctus, quam eget molestie commodo, lacus purus cursus purus, nec rutrum tellus dolor id lorem.</p>
